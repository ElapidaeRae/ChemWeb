...
<div class="flex items-center px-2" onfocusout={dropdownLostFocus}>
	...
	<button class="relative text-text border-4 border-black rounded-full bg-background p-1 m-2 dropdown" onclick={toggleDropdown}>
		<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
